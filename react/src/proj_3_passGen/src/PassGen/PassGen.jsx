      ...
      <div className="h-screen bg-black text-white flex flex-col items-center">
        <div className="bg-gray-700 px-8 py-2 mt-2 w-4xl items-center  flex flex-col">
          ...
          <div className="flex flex-row overflow-hidden ">
            <input
              className="  rounded-l-2xl outline-none px-4  py-3 mt-4 border-white border-2 w-96"
              type="text"
            ...
            <button
              ...
              className="border-white border-2 p-2  mt-4 rounded-r-2xl text-3xl items-center flex justify-center"
            >
              copy
            </button>
          </div>
